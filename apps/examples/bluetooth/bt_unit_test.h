 ...
 */
	typedef enum {
		BT_AMS_ENTITY_ID_PLAYER = 0x00,
									/**< Player */
		BT_AMS_ENTITY_ID_QUEUE = 0x01,
								   /**< Queue */
		BT_AMS_ENTITY_ID_TRACK = 0x02
								  /**< Track */
 ...
 */
	typedef enum {
		BT_AMS_PLAYER_ATTR_ID_NAME = 0x00,
									   /**< PlayerAttributeIDName */
		BT_AMS_PLAYER_ATTR_ID_PLAYBACK_INFO = 0x01,
												/**< PlayerAttributeIDPlaybackInfo */
		BT_AMS_PLAYER_ATTR_ID_VOLUME = 0x02
 ...
 */
	typedef enum {
		BT_AMS_QUEUE_ATTR_ID_INDEX = 0x00,
									   /**< QueueAttributeIDIndex */
		BT_AMS_QUEUE_ATTR_ID_COUNT = 0x01,
									   /**< QueueAttributeIDCount */
		BT_AMS_QUEUE_ATTR_ID_SHUFFLE_MODE = 0x02,
											  /**< QueueAttributeIDShuffleMode */
		BT_AMS_QUEUE_ATTR_ID_REPEAT_MODE = 0x03
 ...
 */
	typedef enum {
		BT_AMS_TRACK_ATTR_ID_ARTIST = 0x00,
										/**< TrackAttributeIDArtist */
		BT_AMS_TRACK_ATTR_ID_ALBUM = 0x01,
									   /**< TrackAttributeIDAlbum */
		BT_AMS_TRACK_ATTR_ID_TITLE = 0x02,
									   /**< TrackAttributeIDTitle */
		BT_AMS_TRACK_ATTR_ID_DURATION = 0x03
