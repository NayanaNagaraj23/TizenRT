...
static void utc_taskmanager_register_n(void)
{
	int ret;
...
static void utc_taskmanager_start_n(void)
{
	int ret;
...
static void utc_taskmanager_set_broadcast_cb_n(void)
{
	int ret;
...
static void utc_taskmanager_set_broadcast_cb_p(void)
{
	int ret;
	tm_msg_t data;
...
static void utc_taskmanager_set_exit_cb_n(void)
{
	int ret;
...
static void utc_taskmanager_set_exit_cb_p(void)
{
	int ret;
	tm_msg_t data;
...
static void utc_taskmanager_unset_broadcast_cb_n(void)
{
	int ret;
...
static void utc_taskmanager_unset_broadcast_cb_p(void)
{
	int ret;
...
static void utc_taskmanager_pause_n(void)
{
	int ret;
...
static void utc_taskmanager_pause_p(void)
{
	int ret;
...
static void utc_taskmanager_resume_n(void)
{
	int ret;
...
static void utc_taskmanager_resume_p(void)
{
	int ret;
...
static void utc_taskmanager_getinfo_with_name_n(void)
{
...
static void utc_taskmanager_getinfo_with_handle_n(void)
{
	tm_appinfo_t *ret;
...
static void utc_taskmanager_stop_n(void)
{
	int ret;
...
static void utc_taskmanager_stop_p(void)
{
	int ret;
...
static void utc_taskmanager_unregister_n(void)
{
	int ret;
...
static void utc_taskmanager_register_task_n(void)
{
	int ret;
...
static void utc_taskmanager_register_pthread_n(void)
{
	int ret;
	pthread_attr_t attr;
...
static void utc_taskmanager_dealloc_broadcast_msg_n(void)
{
	int ret;
...
static void utc_taskmanager_dealloc_broadcast_msg_p(void)
{
	int ret;
...
static void utc_taskmanager_getinfo_with_pid_n(void)
{
	tm_appinfo_t *ret;
...
static void utc_taskmanager_set_stop_cb_n(void)
{
	int ret;
...
static void utc_taskmanager_reply_unicast_n(void)
{
	int ret;
...
void tm_utc_main(void)
{
	...
	utc_taskmanager_register_p();

	utc_taskmanager_register_task_n();
	utc_taskmanager_register_task_p();

	utc_taskmanager_register_pthread_n();
	utc_taskmanager_register_pthread_p();

	utc_taskmanager_start_n();
	utc_taskmanager_start_p();

	utc_taskmanager_getinfo_with_pid_n();
	utc_taskmanager_getinfo_with_pid_p();

	utc_taskmanager_set_unicast_cb_n();
	utc_taskmanager_set_unicast_cb_p();

	utc_taskmanager_set_broadcast_cb_n();
	utc_taskmanager_set_broadcast_cb_p();

	utc_taskmanager_set_exit_cb_n();
	utc_taskmanager_set_exit_cb_p();

	utc_taskmanager_unicast_n();
	utc_taskmanager_unicast_p();

	utc_taskmanager_reply_unicast_n();
	utc_taskmanager_reply_unicast_p();

	utc_taskmanager_broadcast_n();
	utc_taskmanager_broadcast_p();

	utc_taskmanager_pause_n();
	utc_taskmanager_pause_p();

	utc_taskmanager_resume_n();
	utc_taskmanager_resume_p();

	utc_taskmanager_unset_broadcast_cb_n();
	utc_taskmanager_unset_broadcast_cb_p();

	utc_taskmanager_getinfo_with_name_n();
	utc_taskmanager_getinfo_with_name_p();

	utc_taskmanager_getinfo_with_handle_n();
	utc_taskmanager_getinfo_with_handle_p();

	utc_taskmanager_getinfo_with_group_n();
	utc_taskmanager_getinfo_with_group_p();

	utc_taskmanager_clean_infolist_p();
	utc_taskmanager_clean_info_p();

	utc_taskmanager_restart_n();
	utc_taskmanager_restart_p();

	utc_taskmanager_stop_n();
	utc_taskmanager_stop_p();

	utc_taskmanager_unregister_n();
	utc_taskmanager_unregister_p();

	utc_taskmanager_set_stop_cb_n();
	utc_taskmanager_set_stop_cb_p();

	utc_taskmanager_dealloc_broadcast_msg_n();
	utc_taskmanager_dealloc_broadcast_msg_p();
}
