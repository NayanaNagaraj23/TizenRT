...
/**
* @testcase             :itc_net_setsockopt_n_reuseport
* @brief                :SO_REUSEPORT return error because TizenRT doesn't support it
* @scenario             :setsockopt setting flag SO_REUSEPORT
* @apicovered           :setsockopt()
* @precondition         :socket file descriptor
* @postcondition        :None
*/
static void itc_net_setsockopt_n_reuseport(int s)
{
	int ret = -1;
	int option = 1;
...
int itc_net_setsockopt_main(void)
{
	...
	itc_net_setsockopt_n_reuseport(fd);
