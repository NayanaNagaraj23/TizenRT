...
WT_AUTH_TABLE(WIFI_MANAGER_AUTH_OPEN, "open", "open mode")
	...
	WT_AUTH_TABLE(WIFI_MANAGER_AUTH_IBSS_OPEN, "ibss_open", "IBSS ad-hoc mode")
	WT_AUTH_TABLE(WIFI_MANAGER_AUTH_WPS, "wps", "WPS mode")
	WT_AUTH_TABLE(WIFI_MANAGER_AUTH_UNKNOWN, "none", "unknown type")
