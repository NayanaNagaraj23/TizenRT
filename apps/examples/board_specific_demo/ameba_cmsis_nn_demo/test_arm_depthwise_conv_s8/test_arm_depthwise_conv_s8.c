...
#include "../Utils/validate.h"
const int32_t *get_bias_address_s8(const int32_t * bias, int32_t size)  { const int32_t * return_bias = NULL;
	...
	 const q31_t *bias_data = get_bias_address_s8(basic_biases, BASIC_OUT_CH);
	...
	const q31_t *bias_data = get_bias_address_s8(stride2pad1_biases, STRIDE2PAD1_OUT_CH);
	...
	const q31_t *bias_data = get_bias_address_s8(depthwise_2_biases, DEPTHWISE_2_OUT_CH);
	...
	const q31_t *bias_data = get_bias_address_s8(depthwise_out_activation_biases, DEPTHWISE_OUT_ACTIVATION_OUT_CH);
	...
	const q31_t *bias_data = get_bias_address_s8(depthwise_mult_batches_biases, DEPTHWISE_MULT_BATCHES_OUT_CH);
	...
	 const q31_t *bias_data = get_bias_address_s8(depthwise_null_bias_0_biases, DEPTHWISE_NULL_BIAS_0_OUT_CH);
	...
	 const q31_t *bias_data = get_bias_address_s8(depthwise_null_bias_1_biases, DEPTHWISE_NULL_BIAS_1_OUT_CH);
	...
	const q31_t *bias_data = get_bias_address_s8(depthwise_dilation_biases, DEPTHWISE_DILATION_OUT_CH);
	...
	 const q31_t *bias_data = get_bias_address_s8(depthwise_x_stride_biases, DEPTHWISE_X_STRIDE_IN_CH);
